            ...
            <fieldset class=\"grandfield\">
                ...
                <fieldset class=\"Logement\">
                    ...
                    <div class=\"l2\">
                        ...
                        <label for=\"Appartement\" class=\"putbold\">Appartement*</label>
                        <input type=\"radio\" id=\"Maison\" name=\"typeLogement\" required>
                        <label for=\"Maison\" class=\"putbold\">Maison*</label>
                        <input type=\"radio\" id=\"Autre\" name=\"typeLogement\"required>
                        <label for=\"Autre\" class=\"putbold\">Autre*</label>
            ...
            <table id=\"tableauSDB\">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id=\"etat_plafond_sortie\" id=\"etat_plafond_sortie\">
                        <option value=\"\"></option>
                                <option value=\"très bon\">TB</option>
                                <option value=\"bon\">B</option>
                                <option value=\"passable\">P</option>
                    ...
                    <tr>
                        ...
                        <td>
                            <strong>Nombre</strong> : <input id=\"prise_sdb1\" name=\"nombre_prise_electrique_sdb1\" type=\"number\" min=\"0\" placeholder=\"Nombre de prises\">
                        </td>
                        <td>
                            <strong>Nombre</strong> : <input id=\"prise_sdb2\" name=\"nombre_prise_electrique_sdb2\" type=\"number\" min=\"0\" placeholder=\"Nombre de prises\">
                        </td>
                        <td>
